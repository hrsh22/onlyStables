...
export default function Home() {
  ...
  return (
    <div className="bg-black min-h-screen">
      {/* Header */}
      <header className="pt-8 left-0 right-0 z-50 bg-transparent ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* Logo */}
            <div className="flex items-center space-x-2">
              <img src="/logo.svg" alt="Logo" className="w-8 h-8" />
              <span className="text-white font-bold text-4xl italic">onlyStables</span>
            </div>
      ...
      <section className="relative pt-32 pb-16 min-h-screen bg-black">
        {/* Network Background */}
        ...
        <div className="mt-16 sm:mt-24 lg:mt-32 relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-left mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-9xl 2xl:text-9xl font-bold text-white mb-4 sm:mb-6 lg:mb-8 leading-none">
              <div>Swap Stablecoins</div>
              <div>Across <span className="text-[#ff6b35]">Chains</span>.</div>
            </h2>
          </div>
          ...
          {/* <div className="flex gap-8">
            <div className="text-left">
              <div className="text-4xl lg:text-5xl font-bold text-[#ff6b35] mb-2">21</div>
              <div className="text-white text-sm">Chains</div>
            </div>
            <div className="text-left">
              <div className="text-4xl lg:text-5xl font-bold text-[#ff6b35] mb-2">75</div>
            ...
            <div className="mb-8 sm:mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="space-y-3 sm:space-y-4 mt-4 sm:mt-6 lg:mt-8">
                  <p className="text-gray-900 text-sm sm:text-base lg:text-lg leading-relaxed">
                    ...
                    jump through hoops with multiple steps and bridges, onlyStables lets you swap your stablecoins across chains in one simple transaction.
                  </p>

                  <p className="text-gray-900 text-sm sm:text-base lg:text-lg leading-relaxed">
                    Built on NEAR Intents, we focus exclusively on stablecoins, making cross-chain swaps faster, cheaper, and more reliable.
                    Move your USDC, USDT, and other stablecoins between chains without the complexity.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-4 sm:mt-6">
                <div className="border border-gray-900 rounded-full px-2 sm:px-3 py-1 sm:py-1.5">
                  <span className="text-gray-900 font-medium text-xs sm:text-sm">Lesser Time</span>
                </div>
                <div className="border border-gray-900 rounded-full px-2 sm:px-3 py-1 sm:py-1.5">
                  <span className="text-gray-900 font-medium text-xs sm:text-sm">Lower Cost</span>
                </div>
                <div className="border border-gray-900 rounded-full px-2 sm:px-3 py-1 sm:py-1.5">
                  <span className="text-gray-900 font-medium text-xs sm:text-sm">Stablecoins Only</span>
                </div>
                {/* Decorative Line */}
      ...
      <footer className="py-8 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-white text-sm">Swap Stablecoins Across Chains. Fast. Simple. Reliable.</p>
        </div>
      </footer>
    </div>
  );
